...
./plot_puremagic.py -x parallelism -y scheduling_efficiency -s heisenberg \
...
./plot_puremagic.py -x ancilla_qubits -y parallel_efficiency \
    ...
    -f ../results/cliffordt/puremagic-vary-topo/out-square_heisenberg_N225:heisenberg_N225 -o parallel_efficiency_v_qubits_puremagic_ct.png --lines
# relation between scheduling efficiency and expected cultivation times for PureMagic and Bus with Clifford+T
./plot_puremagic.py -x cultivation -y scheduling_efficiency \
...
./plot_puremagic.py -x ancilla_qubits -y scheduling_efficiency \
    -f ../results/cliffordt/puremagic-vary-topo/out-square_heisenberg_N25:heisenberg_N25 \
    -f ../results/cliffordt/puremagic-vary-topo/out-square_heisenberg_N100:heisenberg_N100 \
    -f ../results/cliffordt/puremagic-vary-topo/out-square_heisenberg_N225:heisenberg_N225 -o efficiency_v_qubits_puremagic_ct.png --lines
# relation between transpilation max weight and timesteps for PureMagic
./plot_puremagic.py -x weight -y timesteps -f ../results/vary-weight/puremagic/out-square_heisenberg_N64:heisenberg_N64 -o timesteps_v_weight.png
# relation between transpilation max weight and number of Cliffords for PureMagic
./plot_puremagic.py -x weight -y cliffords -f ../results/vary-weight/puremagic/out-square_heisenberg_N64:heisenberg_N64 -o cliffords_v_weight.png
